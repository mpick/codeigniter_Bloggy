...
<div class="row">
    ...
    <div class="span12 columns">
      <?=form_open(uri_string())?>
        <fieldset>
          <legend>Link Add Form</legend>
          <div class="clearfix">
            <label for="desc">Description</label>
            <div class="input">
              <input class="xlarge" id="xlInput" name="desc" size="30" type="text" value="<?=set_value('desc')?>">
            </div>
          </div><!-- /clearfix -->
          <div class="clearfix">
            <label for="url">URL</label>
            <div class="input">
              <input class="xlarge" id="xlInput" name="url" size="30" type="text" value="<?=set_value('url')?>">
            </div>
          </div><!-- /clearfix -->	  
          <div class="clearfix">
